...
def assemble(d):
    ...
    head = re.sub(r'(<link rel="canonical" href="https://www\.sussexstoragecompany\.co\.uk/)[^"]*(">)', lambda m:m.group(1)+d["file"]+m.group(2), head, 1)
    head = re.sub(r'(<meta property="og:url" content="https://www\.sussexstoragecompany\.co\.uk/)[^"]*(">)', lambda m:m.group(1)+d["file"]+m.group(2), head, 1)
    ...
    head = re.sub(r'(<meta property="og:image" content="https://www\.sussexstoragecompany\.co\.uk/)[^"]*(">)', lambda m:m.group(1)+"images/"+d["hero"]+m.group(2), head, 1)
