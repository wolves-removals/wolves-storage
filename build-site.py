...
CONTAINER_DATA={
 ...
 'pricing.html':("Why Container Storage Is Better Value Than Self-Storage",
   ...
   ["Pay only for the container space you use","Collection &amp; redelivery quoted upfront &mdash; no van to hire","No deposit and no hidden fees","Sealed, dry, alarmed and fully insured"]),
...
TOWNS = [
 ...
 dict(slug="storage-pulborough",town="Pulborough",lat="50.9580",lng="-0.5130",
  ...
  checks=["Same RH20 area as our base","Packing, collection &amp; redelivery quoted upfront","Sealed, dry, alarmed &amp; insured","From &pound;15/week, no deposit"],
 ...
 dict(slug="storage-steyning",town="Steyning",lat="50.8900",lng="-0.3290",
  ...
  checks=["Covering Steyning, Bramber &amp; Beeding","Door collection &amp; redelivery quoted upfront","Sealed, dry, alarmed &amp; insured","From &pound;15/week, no deposit"],
 ...
 dict(slug="storage-horsham",town="Horsham",lat="51.0630",lng="-0.3270",
  ...
  checks=["Collecting across RH12 &amp; RH13","Packing, collection &amp; redelivery quoted upfront","Sealed, alarmed, 24/7 CCTV &amp; insured","From &pound;15/week, no deposit"],
 ...
 dict(slug="storage-worthing",town="Worthing",lat="50.8180",lng="-0.3720",
  ...
  checks=["Collecting across BN11&ndash;BN14","Packing, collection &amp; redelivery quoted upfront","Sealed, alarmed, 24/7 CCTV &amp; insured","From &pound;15/week, no deposit"],
...
def build():
    ...
    P.append(dict(file="index.html",slug="home",nav="Home",
      ...
      sections=[
        hero(IMG(HERO_WAREHOUSE[0]),HERO_WAREHOUSE[1],"Secure Storage in West Sussex",
          ...
          ["Cost-effective long- and short-term storage","Packing, collection &amp; delivery quoted upfront","Fully secure, alarmed &amp; insured","Family-run, LAPADA accredited"]),
    ...
    P.append(service("storage-solutions.html","storage","Storage Solutions",
      ...
      ["Cost-effective long- and short-term storage","Packing, collection &amp; delivery quoted upfront","Fully secure, alarmed &amp; insured","No deposit, flexible weekly terms"],
    ...
    P.append(dict(file="how-it-works.html",slug="how",nav="How It Works",
      ...
      sections=[
        hero(IMG(HERO_LOADING[0]),HERO_LOADING[1],"How Our Managed Storage Works",
          ...
          ["We bring the materials &amp; pack for you","Collection &amp; redelivery quoted upfront","Sealed, individually logged containers","From &pound;15/week, no deposit"],big=False),
        process(),
    ...
    P.append(dict(file="pricing.html",slug="pricing",nav="Pricing",
      ...
      sections=[
        hero(IMG(HERO_WAREHOUSE[0]),HERO_WAREHOUSE[1],"Simple, Transparent Storage Prices",
          ...
          ["From &pound;15 per week, no deposit","Flexible weekly &amp; 4-week terms","Collection &amp; redelivery quoted upfront","Free quote within 24 hours"],big=False),
        '''<style>
...
@media (max-width:600px){
  .pw-matrix{grid-template-columns:minmax(0,1.3fr) minmax(58px,.8fr) minmax(80px,1fr);}
  .pw-dic{display:none;}
  .pw-d{padding:12px 8px 12px 0;}
  .pw-s{padding:12px 9px;}
  .pw-h-m,.pw-m,.pw-f-m{padding-left:9px;padding-right:9px;}
  .pw-dlabel,.pw-sval,.pw-mval{font-size:.85rem;}
  .pw-h-mlabel{font-size:.72rem;}
}
@media (prefers-reduced-motion:reduce){
