...
TOWNS = [
 ...
 dict(slug="storage-storrington",town="Storrington",lat="50.9170",lng="-0.4520",
  ...
  meta="Managed container storage in Storrington from £15/week. Local family team collect, seal and store your belongings — no deposit, fully insured. Free quote in 24 hours.",
 ...
 dict(slug="storage-henfield",town="Henfield",lat="50.9290",lng="-0.2760",
  ...
  meta="Managed container storage in Henfield, West Sussex from £15/week. Your local family alternative — we collect, store and redeliver. No deposit. Free quote in 24 hours.",
 ...
 dict(slug="storage-worthing",town="Worthing",lat="50.8180",lng="-0.3720",
  ...
  meta="Managed storage in Worthing, West Sussex from £15/week. We collect across BN11–BN14, store sealed and redeliver — ideal for moves, downsizing and students. Free quote.",
...
def size_guide_page():
    ...
    return dict(file="storage-size-guide.html",slug="guide",nav="Storage Size Guide",
      ...
      meta="How much storage space do you need? Our West Sussex container size guide shows what fits in a 250 cu ft container, by home size — from £15/week. Free quote in 24 hours.",
...
def furniture_page():
    ...
    return dict(file="furniture-storage.html",slug="furniture",nav="Furniture Storage",
      ...
      meta="Furniture storage in West Sussex from £15/week. We blanket-wrap, collect and seal your furniture into secure containers — fully insured, LAPADA accredited. Free quote.",
...
def build():
    ...
    P.append(service("storage-solutions.html","storage","Storage Solutions",
      "Secure Managed Storage in West Sussex | Wolves Storage Sussex",
      "Secure, fully managed storage in West Sussex from £15/week. We pack, collect, store & redeliver — no deposit, fully insured, LAPADA accredited. Free quote in 24 hours.",
    ...
    P.append(service("long-term-storage.html","longterm","Long-Term Storage",
      "Long-Term Storage in West Sussex from £15/week | Wolves Storage Sussex",
      "Affordable long-term storage in West Sussex from £15/week. Fully insured, 24/7 CCTV, no deposit. Ideal for emigrating, renovations & downsizing. Free quote in 24 hours.",
    ...
    P.append(service("short-term-storage.html","shortterm","Short-Term Storage",
      "Short-Term Storage in West Sussex from £15/week | Wolves Storage Sussex",
      "Flexible short-term storage in West Sussex from £15/week. No deposit, weekly terms, fast collection. Perfect for moves, chain delays & renovations. Free quote in 24 hours.",
    ...
    P.append(service("business-storage.html","business","Business Storage",
      "Business Storage in West Sussex from £15/week | Wolves Storage Sussex",
      "Secure business storage in West Sussex from £15/week. Stock, archives & equipment — fully insured, 24/7 CCTV, flexible terms, collection & redelivery. Free quote in 24 hours.",
    ...
    P.append(dict(file="pricing.html",slug="pricing",nav="Pricing",
      title="Storage Prices in West Sussex from £15/week | Wolves Storage Sussex",
    ...
    P.append(dict(file="gallery.html",slug="gallery",nav="Gallery",
      title="Gallery — Our West Sussex Storage Facility | Wolves Storage Sussex",
    ...
    P.append(dict(file="about.html",slug="about",nav="About",
      title="About Us — Family-Run Storage in West Sussex | Wolves Storage Sussex",
