...
CONTAINER_DATA={
 ...
 'pricing.html':("Why Container Storage Is Better Value Than Self-Storage",
   ...
   ["Pay only for the container space you use","We collect &amp; redeliver &mdash; no van to hire","No deposit and no hidden fees","Sealed, dry, alarmed and fully insured"]),
...
TOWN_LOCAL = {
 ...
 "storage-brighton": ("City Storage for Brighton &amp; Hove Flats &amp; Students",
  ...
  '<p>We&rsquo;re a popular choice with students moving between term-time lets across BN1 to BN3, professionals downsizing or moving in together, and anyone caught between flats. Store for a few summer weeks or the whole year on flexible, fully insured terms, from just &pound;15 a week &mdash; <a href="short-term-storage.html">short-term storage</a> is ideal for the student holidays, with collection and redelivery quoted upfront.</p>'),
...
TOWNS = [
 dict(slug="storage-ashington",town="Ashington",lat="50.9270",lng="-0.4470",
  ...
  sub="We&rsquo;re based right here in Ashington &mdash; clean, dry, fully managed container storage on your doorstep, from just &pound;15 a week with collection and redelivery quoted upfront.",
  ...
  s1=["Our storage facility is right here in Ashington, at Doryln House on London Road (RH20 3JT). That means no driving to an out-of-town unit and no queueing for a lift &mdash; we come to your home, pack and wrap your belongings, seal them into your own wooden container and store them in our alarmed indoor warehouse just minutes away.",
      "Whether you&rsquo;re moving within the village, renovating, decluttering or freeing up a room, you get fully managed storage from just &pound;15 a week with collection and redelivery quoted upfront. See exactly <a href=\"how-it-works.html\">how it works</a> or check our transparent <a href=\"pricing.html\">storage prices</a>."],
  ...
  faqs=[("Where is your storage facility in Ashington?","We&rsquo;re at Doryln House, London Road, Ashington, Pulborough RH20 3JT &mdash; managed container storage right in the village."),
        ...
        ("How much is storage in Ashington?","From just &pound;15 per week per container, with no deposit and no hidden fees. Collection and redelivery are quoted upfront."),
 ...
 dict(slug="storage-storrington",town="Storrington",lat="50.9170",lng="-0.4520",
  ...
  faqs=[("Do you offer storage in Storrington?","Yes &mdash; Storrington is just a few minutes from our Ashington base, so we collect, store and redeliver here with ease."),
        ...
        ("How much is storage in Storrington?","From &pound;15 per week per container, no deposit and no hidden fees, with collection and redelivery quoted upfront."),
 ...
 dict(slug="storage-pulborough",town="Pulborough",lat="50.9580",lng="-0.5130",
  ...
  sub="Pulborough shares our RH20 postcode &mdash; managed container storage right on your doorstep, from &pound;15 a week, with packing, collection and redelivery quoted upfront.",
  checks=["Same RH20 area as our base","We pack, collect &amp; redeliver","Sealed, dry, alarmed &amp; insured","From &pound;15/week, no deposit"],
  ...
  faqs=[("Do you cover Pulborough?","Yes &mdash; Pulborough is in our own RH20 area, so we collect, store and redeliver here quickly."),
        ("Is collection included?","Collection and redelivery across Pulborough are part of our managed service, quoted upfront as one clear charge &mdash; you never hire a van or lift a box, and the &pound;15/week rate covers your storage."),
 ...
 dict(slug="storage-steyning",town="Steyning",lat="50.8900",lng="-0.3290",
  ...
  checks=["Covering Steyning, Bramber &amp; Beeding","Door-to-door collection &amp; redelivery","Sealed, dry, alarmed &amp; insured","From &pound;15/week, no deposit"],
 ...
 dict(slug="storage-horsham",town="Horsham",lat="51.0630",lng="-0.3270",
  ...
  checks=["Collecting across RH12 &amp; RH13","We pack, collect &amp; redeliver","Sealed, alarmed, 24/7 CCTV &amp; insured","From &pound;15/week, no deposit"],
 ...
 dict(slug="storage-worthing",town="Worthing",lat="50.8180",lng="-0.3720",
  ...
  checks=["Collecting across BN11&ndash;BN14","We pack, collect &amp; redeliver","Sealed, alarmed, 24/7 CCTV &amp; insured","From &pound;15/week, no deposit"],
  ...
  faqs=[("Do you cover all of Worthing?","Yes &mdash; we collect, store and redeliver across BN11, BN12, BN13 and BN14, including Goring, Durrington and Findon Valley."),
        ...
        ("How much is storage in Worthing?","From &pound;15 per week per container, no deposit and no hidden fees, with collection and redelivery quoted upfront."),
...
def build():
    ...
    P.append(dict(file="index.html",slug="home",nav="Home",
      ...
      sections=[
        hero(IMG(HERO_WAREHOUSE[0]),HERO_WAREHOUSE[1],"Secure Storage in West Sussex",
          "Need somewhere safe to keep your belongings? Our clean, dry, ultra-secure <strong>containerised storage</strong> suits home and business, short or long-term &mdash; fully managed &mdash; we handle packing, collection and delivery.",
          ["Cost-effective long- and short-term storage","We pack, collect &amp; redeliver","Fully secure, alarmed &amp; insured","Family-run, LAPADA accredited"]),
    ...
    P.append(service("storage-solutions.html","storage","Storage Solutions",
      ...
      ["Cost-effective long- and short-term storage","We pack, collect &amp; redeliver","Fully secure, alarmed &amp; insured","No deposit, flexible weekly terms"],
      ...
      [("How much does storage cost?","From &pound;15 per week with no deposit and no hidden fees, on flexible weekly and 4-week rolling terms."),
       ...
       ("Do you pack and collect for me?","Yes &mdash; collection, professional packing and redelivery are quoted upfront. You never hire a van or lift a box."),
    ...
    P.append(service("long-term-storage.html","longterm","Long-Term Storage",
      ...
      [("How much does long-term storage cost?","From &pound;15 per week with no deposit, and the longer you store the better the value &mdash; ask about long-term rates on your free quote."),
       ...
       ("Do you collect and redeliver?","Collection and redelivery across West Sussex are part of our managed service, quoted upfront as one clear charge, separate from the &pound;15/week storage rate. We bring the materials, pack, load and store; you never hire a van or lift a box."),
    ...
    P.append(service("short-term-storage.html","shortterm","Short-Term Storage",
      ...
      ("Flexible Storage for Exactly As Long As You Need",["House move delayed? Staging your home for sale? Quick renovation? Short-term storage gives you flexible, secure space for exactly as long as you need.","You pay by the week and stop whenever you like, with collection and redelivery quoted upfront."]),
      ...
      [("How short can I store for?","As little as a week &mdash; billed weekly with no deposit, so you only pay for the time you need."),
       ...
       ("How much does short-term storage cost?","From &pound;15 per week per container with no deposit and no hidden fees &mdash; collection and redelivery quoted upfront."),
    ...
    P.append(service("business-storage.html","business","Business Storage",
      ...
      [("What can I store as a business?","Stock, ecommerce inventory, archives and documents, tools and equipment, seasonal items and more."),
       ...
       ("Can you collect and redeliver?","Absolutely &mdash; collection and redelivery are quoted upfront, saving your team the hassle."),
    ...
    P.append(dict(file="how-it-works.html",slug="how",nav="How It Works",
      ...
      sections=[
        hero(IMG(HERO_LOADING[0]),HERO_LOADING[1],"How Our Managed Storage Works",
          ...
          ["We bring the materials &amp; pack for you","We collect &amp; redeliver","Sealed, individually logged containers","From &pound;15/week, no deposit"],big=False),
        process(),
        ...
        split("bg-lightgrey","The Container Explained",["Each wooden container measures 5ft &times; 7ft &times; 8.6ft &mdash; 250 cu ft, roughly the contents of a one-bedroom flat. Containers are sealed, logged and stacked in our secure indoor facility.","Need more space? We simply use additional containers, so you only pay for what you use."],IMG("hero-packed-container.webp"),"A packed storage container",reverse=True),
                '''<style>
.hx-sec{background:#F7F5EF;color:#46505a;padding:5.5rem 1.25rem;position:relative;}
.hx-wrap{max-width:1180px;margin:0 auto;}
.hx-head{max-width:760px;margin:0 auto 3.5rem;}

.hx-eyebrow{display:inline-flex;align-items:center;gap:.7rem;text-transform:uppercase;letter-spacing:.2em;font-size:.74rem;font-weight:700;color:#5d6a75;margin:0 0 1.1rem;}
.hx-eyebrow::before{content:"";width:30px;height:2px;background:linear-gradient(90deg,#828c96,rgba(130,140,150,.18));display:inline-block;}
...
.hx-h2 em{font-style:normal;color:#5d6a75;}

.hx-lead{font-size:1.13rem;line-height:1.75;color:#46505a;margin:0;}
.hx-lead::first-letter{float:left;font-size:3.7rem;line-height:.8;font-weight:800;color:#4a5560;padding:.32rem .55rem 0 0;}

.hx-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1.6rem;position:relative;}

.hx-step{position:relative;display:flex;flex-direction:column;background:linear-gradient(180deg,#FBF9F3 0%,#F0ECDF 100%);border:1px solid rgba(105,119,131,.2);border-radius:20px;padding:2rem 1.75rem 1.7rem;box-shadow:0 1px 2px rgba(35,40,45,.04),0 14px 30px -22px rgba(74,85,96,.42);transition:transform .3s cubic-bezier(.2,.7,.3,1),box-shadow .3s ease,border-color .3s ease;overflow:hidden;}
.hx-step::before{content:"";position:absolute;top:0;left:2rem;width:56px;height:4px;border-radius:0 0 4px 4px;background:linear-gradient(90deg,#697783,#828c96);}
.hx-step:hover{transform:translateY(-6px);box-shadow:0 24px 46px -24px rgba(74,85,96,.5);border-color:rgba(93,106,117,.45);}

.hx-top{display:flex;align-items:center;gap:.9rem;margin-bottom:1.25rem;}
.hx-num{flex:none;width:46px;height:46px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:1.12rem;color:#4a5560;background:linear-gradient(180deg,#EAE6DB,#E8E6DA);border:1px solid rgba(105,119,131,.28);box-shadow:inset 0 1px 0 rgba(255,255,255,.6);transition:color .3s ease,border-color .3s ease,background .3s ease;}
.hx-step:hover .hx-num{color:#23282d;border-color:rgba(74,85,96,.5);}
.hx-icon{flex:none;width:48px;height:48px;border-radius:13px;display:flex;align-items:center;justify-content:center;background:#E8E6DA;color:#5d6a75;border:1px solid rgba(105,119,131,.16);}
.hx-icon svg{width:24px;height:24px;}
.hx-flow{margin-left:auto;flex:none;width:40px;height:40px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(180deg,#6f7d89,#5d6a75);color:#F7F5EF;box-shadow:0 6px 14px -6px rgba(74,85,96,.7);transition:transform .3s ease;}
.hx-flow svg{width:18px;height:18px;display:block;transition:transform .3s ease;}
.hx-step:hover .hx-flow--right svg{transform:translateX(4px);}
.hx-step:hover .hx-flow--down svg{transform:translateY(4px);}

.hx-kicker{text-transform:uppercase;letter-spacing:.18em;font-size:.7rem;font-weight:700;color:#5d6a75;margin:0 0 .5rem;}
.hx-title{font-size:1.3rem;line-height:1.2;font-weight:800;color:#23282d;letter-spacing:-.01em;margin:0 0 .65rem;}
.hx-summary{font-size:1.02rem;font-weight:700;color:#46505a;line-height:1.4;margin:0 0 .9rem;}
.hx-body{font-size:.96rem;line-height:1.68;color:#46505a;margin:0 0 1.5rem;}
.hx-body strong{color:#23282d;font-weight:700;}
.hx-body a{color:#23282d;font-weight:700;text-decoration:underline;text-decoration-color:rgba(105,119,131,.55);text-decoration-thickness:1.5px;text-underline-offset:3px;transition:color .2s ease,text-decoration-color .2s ease;}
.hx-body a:hover{color:#4a5560;text-decoration-color:#5d6a75;}
.hx-body a:focus-visible{outline:2px solid #5d6a75;outline-offset:3px;border-radius:3px;}

.hx-chip{margin-top:auto;align-self:flex-start;display:inline-flex;align-items:center;gap:.5rem;background:#EAE6DB;border:1px solid rgba(105,119,131,.32);color:#46505a;font-size:.78rem;font-weight:700;letter-spacing:.02em;padding:.5rem .9rem;border-radius:999px;}
.hx-chip svg{width:14px;height:14px;color:#5d6a75;flex:none;}

.hx-cta{position:relative;display:flex;flex-direction:column;justify-content:center;align-items:flex-start;background:linear-gradient(155deg,#4a5560 0%,#3a434c 100%);border-radius:20px;padding:2.3rem 2rem;color:#fff;overflow:hidden;box-shadow:0 20px 44px -24px rgba(35,40,45,.6);}
.hx-cta::before{content:"";position:absolute;top:0;left:2rem;width:56px;height:4px;border-radius:0 0 4px 4px;background:linear-gradient(90deg,#828c96,rgba(130,140,150,.2));}
.hx-cta::after{content:"";position:absolute;right:-50px;bottom:-50px;width:180px;height:180px;border-radius:50%;background:radial-gradient(circle,rgba(247,245,239,.08),transparent 70%);pointer-events:none;}
.hx-cta__mark{position:relative;display:inline-flex;align-items:center;justify-content:center;width:48px;height:48px;border-radius:14px;background:rgba(247,245,239,.1);border:1px solid rgba(247,245,239,.18);color:#FC9700;margin-bottom:1.15rem;}
.hx-cta__mark svg{width:24px;height:24px;}
.hx-cta__tag{position:relative;text-transform:uppercase;letter-spacing:.18em;font-size:.68rem;font-weight:700;color:#EAE6DB;margin:0 0 .55rem;}
.hx-cta__txt{position:relative;font-size:1.34rem;font-weight:800;line-height:1.25;letter-spacing:-.01em;margin:0 0 1.5rem;color:#fff;}
.hx-cta__txt em{font-style:normal;color:#EAE6DB;}
.hx-cta__link{position:relative;display:inline-flex;align-items:center;gap:.55rem;background:#FC9700;color:#23282d;font-weight:800;font-size:.95rem;padding:.8rem 1.4rem;border-radius:999px;text-decoration:none;box-shadow:0 10px 24px -10px rgba(252,151,0,.6);transition:transform .25s ease,box-shadow .25s ease,background .25s ease;}
.hx-cta__link svg{width:16px;height:16px;transition:transform .25s ease;}
.hx-cta__link:hover{transform:translateY(-2px);box-shadow:0 16px 30px -10px rgba(252,151,0,.7);background:#ffa61f;}
.hx-cta__link:hover svg{transform:translateX(4px);}
.hx-cta__link:focus-visible{outline:3px solid #fff;outline-offset:3px;}

.hx-note{max-width:820px;margin:3.25rem auto 0;padding-top:2rem;border-top:1px solid rgba(74,85,96,.18);font-size:1.02rem;line-height:1.75;color:#46505a;}
.hx-note a{color:#23282d;font-weight:700;text-decoration:underline;text-decoration-color:rgba(105,119,131,.55);text-decoration-thickness:1.5px;text-underline-offset:3px;transition:color .2s ease,text-decoration-color .2s ease;}
.hx-note a:hover{color:#4a5560;text-decoration-color:#5d6a75;}
.hx-note a:focus-visible{outline:2px solid #5d6a75;outline-offset:3px;border-radius:3px;}
...
@media(prefers-reduced-motion:reduce){
  .hx-step,.hx-flow svg,.hx-num,.hx-icon,.hx-cta__link,.hx-cta__link svg{transition:none;}
  .hx-step:hover{transform:none;}
  .hx-step:hover .hx-flow--right svg,.hx-step:hover .hx-flow--down svg{transform:none;}
}
  ...
  <div class="hx-wrap">
    ...
    <div class="hx-grid">
      ...
      <article class="hx-cta">
        <span class="hx-cta__mark" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 3v18"/><path d="M5 4h11l-2 3 2 3H5"/></svg>
        </span>
    ...
    P.append(dict(file="pricing.html",slug="pricing",nav="Pricing",
      ...
      meta="Transparent storage prices in West Sussex from £15/week. No deposit or hidden fees, flexible weekly & 4-week terms; collection quoted upfront.",
      hero=IMG(HERO_WAREHOUSE[0]),faqs=[("How much is storage?","From &pound;15 per week per container with no deposit and no hidden fees."),("Are there any extra fees?","No hidden fees. Optional extras are extended insurance cover and help unpacking."),("Is collection included?","Collection and redelivery across West Sussex are part of our managed service, quoted upfront as one clear charge, separate from the &pound;15/week storage rate.")],
      sections=[
        hero(IMG(HERO_WAREHOUSE[0]),HERO_WAREHOUSE[1],"Simple, Transparent Storage Prices",
          "Storage from just &pound;15 per week with no deposit and no hidden fees. You only pay for the container space you use &mdash; collection and redelivery quoted upfront.",
          ["From &pound;15 per week, no deposit","Flexible weekly &amp; 4-week terms","We collect &amp; redeliver","Free quote within 24 hours"],big=False),
        '''<style>
...
/* ---- Estimator (segment 02) — cream-gradient card matching the stat panels ---- */
.pw-estimator{position:relative;margin:clamp(24px,3vw,34px) 0 0;padding:clamp(26px,3.5vw,40px);border:1px solid rgba(105,119,131,.18);border-radius:20px;background:linear-gradient(155deg,#F5F2EA 0%,#EAE5D8 100%);overflow:hidden;isolation:isolate;max-width:760px;}
.pw-estimator::before{content:"";position:absolute;top:0;left:clamp(26px,3.5vw,40px);width:40px;height:3px;background:linear-gradient(90deg,#6f7d89,#566069);border-radius:0 0 3px 3px;}
.pw-estimator::after{content:"";position:absolute;right:-54px;bottom:-64px;width:210px;height:210px;border-radius:46px;background:rgba(105,119,131,.06);transform:rotate(18deg);z-index:-1;}
.pw-est-lead{font-size:.78rem;text-transform:uppercase;letter-spacing:.12em;font-weight:700;color:#23282d;margin:0 0 20px;}
.pw-est-lead span{color:#5d6a75;}
.pw-choices{display:flex;flex-wrap:wrap;gap:8px;margin:0 0 clamp(24px,3vw,30px);}
.pw-choice{flex:1 1 140px;min-width:130px;background:rgba(255,255,255,.5);border:1px solid rgba(105,119,131,.2);border-radius:13px;margin:0;padding:13px 15px;text-align:left;cursor:pointer;transition:background .2s ease,border-color .2s ease,box-shadow .2s ease;}
...
.pw-choice:hover{background:rgba(255,255,255,.82);border-color:rgba(105,119,131,.3);}
.pw-choice:hover .pw-choice-label{color:#23282d;}
.pw-choice--active{background:#fff;border-color:rgba(105,119,131,.4);box-shadow:0 8px 20px -12px rgba(74,85,96,.7);}
.pw-choice--active .pw-choice-label{color:#23282d;}
.pw-choice:focus-visible{outline:2px solid #5d6a75;outline-offset:2px;}
...
/* ---- Managed vs self (segment 03) — side-by-side comparison matrix ---- */
.pw-compare{position:relative;margin:clamp(24px,3vw,34px) 0 0;padding:clamp(26px,3.5vw,40px);border:1px solid rgba(105,119,131,.18);border-radius:20px;background:linear-gradient(155deg,#F5F2EA 0%,#EAE5D8 100%);overflow:hidden;isolation:isolate;max-width:880px;}
.pw-compare::before{content:"";position:absolute;top:0;left:clamp(26px,3.5vw,40px);width:40px;height:3px;background:linear-gradient(90deg,#6f7d89,#566069);border-radius:0 0 3px 3px;}
.pw-compare::after{content:"";position:absolute;right:-54px;bottom:-64px;width:210px;height:210px;border-radius:46px;background:rgba(105,119,131,.06);transform:rotate(18deg);z-index:-1;}
.pw-cinstruct{margin:0 0 26px;font-size:.95rem;line-height:1.55;color:#5a636c;max-width:540px;}
.pw-matrix{display:grid;grid-template-columns:minmax(150px,1.32fr) minmax(120px,1fr) minmax(134px,1.06fr);column-gap:clamp(10px,1.6vw,18px);position:relative;}
.pw-cell{position:relative;display:flex;align-items:center;}
/* dimension rail */
.pw-d{gap:13px;padding:18px 6px 18px 2px;border-bottom:1px solid rgba(105,119,131,.13);}
.pw-dic{flex:0 0 auto;width:38px;height:38px;border-radius:11px;display:grid;place-items:center;background:rgba(255,255,255,.72);border:1px solid rgba(105,119,131,.2);color:#5d6a75;}
.pw-dic svg{width:20px;height:20px;}
.pw-dlabel{font-weight:600;color:#37414a;font-size:1.05rem;line-height:1.25;}
.pw-h-d{border-bottom:0;}
.pw-f-d{align-items:flex-start;padding:18px 6px 0 2px;font-size:.74rem;text-transform:uppercase;letter-spacing:.08em;font-weight:800;color:#6b7480;}
/* shared option-column chip + value */
.pw-s,.pw-m{justify-content:center;gap:10px;padding:18px 12px;text-align:center;}
.pw-sval{color:#7d838b;font-weight:600;font-size:1.01rem;}
.pw-mval{color:#23282d;font-weight:700;font-size:1.03rem;line-height:1.25;}
.pw-x,.pw-check{flex:0 0 auto;width:24px;height:24px;border-radius:50%;display:grid;place-items:center;}
.pw-x{background:rgba(150,134,110,.16);color:#a4937c;}
.pw-x svg{width:11px;height:11px;}
.pw-check{background:rgba(105,119,131,.17);color:#46505a;}
.pw-check svg{width:13px;height:13px;}
/* self column-card (recessed) */
.pw-h-s,.pw-s,.pw-f-s{background:rgba(105,119,131,.05);border-left:1px solid rgba(105,119,131,.14);border-right:1px solid rgba(105,119,131,.14);}
.pw-h-s{border-top:1px solid rgba(105,119,131,.14);border-radius:14px 14px 0 0;flex-direction:column;justify-content:flex-end;padding:18px 10px 15px;text-align:center;font-size:.74rem;text-transform:uppercase;letter-spacing:.07em;font-weight:800;color:#9aa1a8;}
.pw-f-s{border-bottom:1px solid rgba(105,119,131,.14);border-radius:0 0 14px 14px;flex-direction:column;justify-content:center;padding:16px 12px 18px;text-align:center;color:#8b9097;font-weight:600;font-size:.95rem;}
/* managed column-card (elevated) */
.pw-h-m,.pw-m,.pw-f-m{background:#fff;border-left:1px solid rgba(105,119,131,.3);border-right:1px solid rgba(105,119,131,.3);}
.pw-h-m{border-top:1px solid rgba(105,119,131,.3);border-radius:14px 14px 0 0;flex-direction:column;justify-content:flex-end;align-items:center;gap:9px;padding:20px 10px 16px;text-align:center;box-shadow:0 -16px 30px -22px rgba(74,85,96,.45);}
.pw-h-m::before{content:"";position:absolute;top:0;left:50%;transform:translateX(-50%);width:44px;height:3px;background:linear-gradient(90deg,#6f7d89,#566069);border-radius:0 0 3px 3px;}
.pw-f-m{border-bottom:1px solid rgba(105,119,131,.3);border-radius:0 0 14px 14px;flex-direction:column;justify-content:center;gap:2px;padding:15px 12px 18px;text-align:center;box-shadow:0 28px 46px -30px rgba(74,85,96,.6);}
.pw-pill{display:inline-flex;align-items:center;gap:5px;background:#5d6a75;color:#fff;font-size:.61rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;padding:5px 11px;border-radius:999px;box-shadow:0 7px 16px -8px rgba(74,85,96,.85);}
.pw-pill svg{width:11px;height:11px;}
.pw-h-mlabel{font-size:.84rem;text-transform:uppercase;letter-spacing:.05em;font-weight:800;color:#23282d;}
.pw-f-m strong{font-size:1.22rem;color:#23282d;font-weight:800;letter-spacing:-.01em;}
.pw-f-m span{font-size:.85rem;color:#5a636c;}

/* ---- Responsive ---- */
@media (max-width:720px){
  .pw-seg{grid-template-columns:1fr;gap:8px;}
...
@media (max-width:600px){
  /* stack each dimension: full-width label, then self + managed as side-by-side chips */
  .pw-matrix{grid-template-columns:1fr 1fr;column-gap:10px;}
  .pw-h-d,.pw-dic{display:none;}
  .pw-d,.pw-f-d{grid-column:1 / -1;}
  .pw-d{border-bottom:0;padding:17px 2px 9px;}
  .pw-dlabel{font-size:1rem;}
  .pw-f-d{align-items:flex-start;padding:15px 2px 9px;}
  .pw-h-s,.pw-s,.pw-f-s,.pw-h-m,.pw-m,.pw-f-m{border-radius:13px;margin-bottom:8px;padding:13px 10px;text-align:center;justify-content:center;}
  .pw-h-s,.pw-s,.pw-f-s{border:1px solid rgba(105,119,131,.16);background:rgba(105,119,131,.05);}
  .pw-h-m,.pw-m,.pw-f-m{border:1px solid rgba(105,119,131,.32);background:#fff;box-shadow:0 8px 18px -13px rgba(74,85,96,.5);}
  .pw-h-s,.pw-h-m{margin-bottom:5px;}
  .pw-h-m{padding-top:15px;}
  .pw-f-s,.pw-f-m{margin-bottom:0;}
  .pw-sval,.pw-mval{font-size:.95rem;}
  .pw-f-m strong{font-size:1.12rem;}
}
@media (prefers-reduced-motion:reduce){
  .pw-box,.pw-choice,.pw-choice-label,.pw-body a{transition:none !important;}
}
  ...
  <div class="pw-wrap">
    ...
    <!-- Segment 01 -->
    <div class="pw-seg">
      <div class="pw-idx"><span class="pw-num" aria-hidden="true">01</span></div>
      <div class="pw-content">
        <p class="pw-kicker">Pricing factors</p>
    ...
    <!-- Segment 02 (with estimator) -->
    <div class="pw-seg">
      <div class="pw-idx"><span class="pw-num" aria-hidden="true">02</span></div>
      <div class="pw-content">
        <p class="pw-kicker">Typical costs</p>
          ...
          <div class="pw-result">
            <div class="pw-boxes" aria-hidden="true">
              <template x-for="n in 3" :key="n">
                <span class="pw-box" :class="{'pw-box--on': n <= (current.boxes||0)}">
    ...
    <!-- Segment 03 (with comparison ledger) -->
    <div class="pw-seg">
      <div class="pw-idx"><span class="pw-num" aria-hidden="true">03</span></div>
      <div class="pw-content">
        <p class="pw-kicker">Managed vs self</p>
        <h3 class="pw-h3">Managed storage vs a self-storage unit</h3>
        <p class="pw-body">A drive-up self-storage unit can look cheaper on the headline rate, but the real cost adds up quickly once you factor in van hire, fuel, the hours spent driving back and forth, and paying for floor space you never fully use. With our managed model there is nothing to hire and nothing to carry: collection from your door and redelivery are quoted upfront as one clear charge, our team packs and loads everything for you, and because we stack sealed containers efficiently in a secure warehouse you pay only for the volume your belongings take up. For most households and businesses across West Sussex it works out cleaner, more secure and better value &mdash; with none of the heavy lifting.</p>

        <div class="pw-compare">
          <p class="pw-cinstruct">See it side by side. A self-storage unit looks cheap on the sticker &mdash; then the van, the fuel and the lost weekends pile on top. Ours stays one flat weekly price.</p>
          <div class="pw-matrix" role="group" aria-label="A self-storage unit compared with our managed storage">

            <div class="pw-cell pw-h-d" aria-hidden="true"></div>
            <div class="pw-cell pw-h-s">A self-storage unit</div>
            <div class="pw-cell pw-h-m"><span class="pw-pill"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2.5 7.5l3 3 6-7"/></svg>The Wolves way</span><span class="pw-h-mlabel">Managed storage</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M20.5 13.3 13.3 20.5a2 2 0 0 1-2.8 0l-6.5-6.5A2 2 0 0 1 3.4 12V5a2 2 0 0 1 2-2H12a2 2 0 0 1 1.4.6l6.5 6.5a2 2 0 0 1 0 2.8Z"/><circle cx="7.8" cy="7.8" r="1.3"/></svg></span><span class="pw-dlabel">Headline rate</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">Cheap on paper</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">&pound;15/wk storage</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="7" width="10.5" height="8" rx="1"/><path d="M13 9.5h3.6l3.4 3.4V15h-2.2"/><circle cx="6.6" cy="17" r="1.8"/><circle cx="16.8" cy="17" r="1.8"/></svg></span><span class="pw-dlabel">Van hire</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">&pound;60&ndash;&pound;100</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">We bring the van</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.2s5 5.4 5 8.8a5 5 0 0 1-10 0c0-3.4 5-8.8 5-8.8Z"/></svg></span><span class="pw-dlabel">Fuel &amp; mileage</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">On top</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">In your quote</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8.5"/><path d="M12 7.2v5l3.4 2"/></svg></span><span class="pw-dlabel">Hours driving back and forth</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">Your weekends</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">Zero &mdash; we do it</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="3.5" width="17" height="17" rx="2"/><path d="M3.5 10h17M10 20.5V10"/></svg></span><span class="pw-dlabel">Floor space you never fully use</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">Paid for in full</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">Only what you use</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.9 20.6 7.4v9.2L12 21.1 3.4 16.6V7.4Z"/><path d="M3.4 7.4 12 12l8.6-4.6M12 12v9.1"/></svg></span><span class="pw-dlabel">Packing &amp; loading</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">You do the lifting</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">Our team does it</span></div>

            <div class="pw-cell pw-d"><span class="pw-dic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11 12 4.5 20 11"/><path d="M5.8 9.8V19h12.4V9.8"/><path d="M10 19v-4.5h4V19"/></svg></span><span class="pw-dlabel">Collection &amp; redelivery</span></div>
            <div class="pw-cell pw-s"><span class="pw-x"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M5 5l10 10M15 5 5 15"/></svg></span><span class="pw-sval">Not offered</span></div>
            <div class="pw-cell pw-m"><span class="pw-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5l4.5 4.5L19 7"/></svg></span><span class="pw-mval">One clear charge</span></div>

            <div class="pw-cell pw-f-d">Bottom line</div>
            <div class="pw-cell pw-f-s">It all stacks up</div>
            <div class="pw-cell pw-f-m"><strong>&pound;15/week</strong><span>one clear charge</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Segment 04 -->
    <div class="pw-seg">
      <div class="pw-idx"><span class="pw-num" aria-hidden="true">04</span></div>
      <div class="pw-content">
        <p class="pw-kicker">Total transparency</p>
    ...
    <!-- Segment 05 -->
    <div class="pw-seg">
      <div class="pw-idx"><span class="pw-num" aria-hidden="true">05</span></div>
      <div class="pw-content">
        <p class="pw-kicker">Next step</p>
  ...
  <script>
    document.addEventListener('alpine:init', () => {
      Alpine.data('pwPricing', () => ({
        ...
        select(i) {
          this.selected = i;
          this.animatePrice((this.current && this.current.price) || 15);
        },
        animatePrice(target) {
        ...
        init() { this.displayPrice = (this.current && this.current.price) || 15; }
      }));
    });
  </script>
</section>''',
        ...
        faq([("How much is storage?","From &pound;15 per week per container with no deposit and no hidden fees."),("Are there any extra fees?","No hidden fees. Optional extras are extended insurance cover and help unpacking."),("Is collection included?","Collection and redelivery across West Sussex are part of our managed service, quoted upfront as one clear charge, separate from the &pound;15/week storage rate.")]),
...
@media(prefers-reduced-motion:reduce){.ab-cta,.ab-cta svg{transition:none}.ab-cta:hover{transform:none}.ab-cta:hover svg{transform:none}}
  ...
  <div class="ab-wrap">
    ...
    <div class="ab-topics">
      ...
      <article class="ab-topic">
        <div class="ab-text">
          ...
          <p class="ab-body">It&rsquo;s easy to assume a drive-up self-storage unit is the cheaper option, but the costs quietly add up &mdash; van hire, fuel, the hours spent driving back and forth, and paying for floor space you never fully use. With our managed model there&rsquo;s nothing to hire and nothing to carry: collection and redelivery are quoted upfront as one clear charge, and because we stack sealed containers efficiently in a secure warehouse rather than renting you an oversized room, you only pay for the space your belongings actually take up. It&rsquo;s usually cleaner, more secure and better value &mdash; your things sit in a dry, alarmed building instead of an unheated metal room you have to visit yourself.</p>
        </div>
        <figure class="ab-figure">
    ...
    for d in P:
        ...
        html=fix_amps(html)
        _fp=os.path.join(SITE,d["file"]); os.makedirs(os.path.dirname(_fp),exist_ok=True)
        open(_fp,"w",encoding="utf-8").write(html)
        print(f"  built {d['file']:28} {len(html)//1024}KB")
    ...
    # _redirects — 301 the old flat blog URLs to the new /blog/ structure (Cloudflare Pages)
    reds=[f"/{d['file'].replace('blog/','blog-',1)} /{d['file']} 301" for d in P if d["file"].startswith("blog/")]
    open(os.path.join(SITE,"_redirects"),"w",encoding="utf-8").write("\n".join(reds)+"\n")
    print(f"  _redirects   {len(reds)} blog 301s")
